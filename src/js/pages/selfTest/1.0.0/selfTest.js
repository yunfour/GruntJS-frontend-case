define(function(require) {
    ...
    var deviceLst    = $('#J-deviceLst'),
        deviceLstBd  = deviceLst.find('tbody'),
        addDeviceBtn = $('#J-addDeviceBtn');
    
    // 创建一条新的设备信息
    function createDeviceLine(data) {
        var deviceLine = [
            '<tr data-keyid="' + data.keyId + '">',
    ...
    deviceLst.on('click', 'a.J-del', function() {
        var delBtn = $(this),
            line   = delBtn.closest('tr'),
            keyid  = line.attr('date-keyid');
    ...
    // "应用测试流程"Tab切换
    var testFlowTab   = $('#J-testFlowTab'),
        developerFlow = $('#J-developerFlow'),
        spreaderFlow  = $('#J-spreaderFlow');
