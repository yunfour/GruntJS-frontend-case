define(function(require) {
    var $            = require('$'),
        ...
        validateForm = require('common/validateForm/0.0.1/validateForm');
    ...
    var theFrm              = $('#J-theFrm'),
        ...
        role                = theFrm.find('input[name=role]'),
        
        userName            = $('#username'),
        email               = $('#email'),
        confirmPassword     = $('#confirmPassword'),
        checkCode           = $('#checkCode'),
        accountType         = theFrm.find('input[name=accountType]'),
        ...
        idNum               = $('#idNum'),
        mobile              = $('#mobile'),
        bankOfPerson        = $('#bankOfPerson'),
        bankAccountOfPerson = $('#bankAccountOfPerson'),
        
        roleCheckboxPanel   = $('#J-roleCheckboxPanel'),
        companyInfo         = $('#J-companyInfo'),
        personalInfo        = $('#J-personalInfo'),
    ...
    roleCheckboxPanel.delegate('span.reg-checkbox', 'click', function() {
        var theLabel     = $(this),
            roleChkbox   = theLabel.children('input[name=role]'),
            checkedClass = 'reg-checkbox-checked',
            isChecked    = theLabel.hasClass(checkedClass);
    ...
    theFrm.delegate('a.J-editBtn', 'click', function() {
        var editBtn     = $(this),
            frmItm      = editBtn.closest('div.com-form-item'),
            editPanel   = frmItm.find('div.J-editPanel'),
            infoPanel   = frmItm.find('div.J-infoPanel');
    ...
    theFrm.delegate('input.J-saveBtn', 'click', function() {
        var saveBtn     = $(this),
            frmItm      = saveBtn.closest('div.com-form-item'),
            editPanel   = frmItm.find('div.J-editPanel'),
            infoPanel   = frmItm.find('div.J-infoPanel'),
            field       = editPanel.find('input').eq(0),
    ...
    theFrm.delegate('input.J-cancelBtn', 'click', function() {
        var cancelBtn     = $(this),
            frmItm      = cancelBtn.closest('div.com-form-item'),
            editPanel   = frmItm.find('div.J-editPanel'),
            infoPanel   = frmItm.find('div.J-infoPanel'),
            field       = editPanel.find('input').eq(0);
