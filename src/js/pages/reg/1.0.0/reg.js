define(function(require) {
    ...
    var regFrm              = $('#J-regFrm'),
        ...
        role                = regFrm.find('input[name=role]'),
        ...
        checkCode           = $('#checkCode'),
        checkCodeImg        = $('#J-regFrmChkCode'),
        refreshChkcodeBtn   = $('#J-refreshChkcode'),
        
        accountType         = regFrm.find('input[name=accountType]'),
        ...
        submitBtn           = regFrm.find('input[type=submit]');
    ...
    regFrm.on('submit', function() {
        var isVali = function() {
            var flag = true,
                valiResult = isPassVali(regFrm, validatePlan);
