define(function(require) {
    ...
    var dialogHtml = [
        '<div style="padding: 30px 0">',
            '<div class="com-form-item" style="padding-left:110px">',
                '<label class="com-label" style="width:100px">imei码：</label>',
                '<input class="com-input" type="text" name="imeicode" value="" style="width:280px" />',
                '<div class="com-form-explain com-form-explain-block com-form-explain-hasIco" style="display:none"><i class="com-ico com-form-ico"></i><span></span></div>',
            '</div>',
    ...
    function addTestDeviceDialog(callback) {
        var contentEle = $(dialogHtml),
            imieCode   = contentEle.find('input[name=imeicode]'),
            explain    = contentEle.find('div.com-form-explain'),
            xhrObj;
        ...
        function showExplain(isShow, type, explainTxt) {
            if(isShow) {
                ...
                explain.removeClass()
                       .addClass('com-form-explain com-form-explain-block com-form-explain-hasIco com-form-explain-' + type);
                
                explain.find('i.com-ico')
                       .removeClass()
                       .addClass('com-ico com-form-ico com-form-ico-' + type);
