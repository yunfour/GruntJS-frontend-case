define("pages/editApp/1.0.0/editApp", [ "$", "./uploadAppIco", "gallery/upload/1.1.1/upload", "components/tip/0.0.1/tip", "./setFrm", "common/validateForm/0.0.1/validateForm" ], function(require) {
    var $ = require("$");
    require("./uploadAppIco");
    require("./setFrm");
});

define("pages/editApp/1.0.0/setFrm", [ "$", "common/validateForm/0.0.1/validateForm" ], function(require) {
    var $ = require("$");
...
define("pages/editApp/1.0.0/uploadAppIco", [ "$", "gallery/upload/1.1.1/upload", "components/tip/0.0.1/tip" ], function(require) {
