define("pages/uploadAPK/1.0.0/template", [], function(require) {
...
define("pages/uploadAPK/1.0.0/uploadAPK", [ "$", "gallery/upload/1.1.1/upload", "gallery/juicer/0.6.5/juicer", "common/tools/0.0.1/tools", "components/tip/0.0.1/tip", "components/progress/0.0.1/progress", "./template" ], function(require) {
    var $ = require("$");
    var Upload = require("gallery/upload/1.1.1/upload"), juicer = require("gallery/juicer/0.6.5/juicer"), tools = require("common/tools/0.0.1/tools"), Tip = require("components/tip/0.0.1/tip"), Progress = require("components/progress/0.0.1/progress");
