define("pages/myAccount/1.0.0/myAccount", [ "$", "components/vScroll/0.0.1/vScroll", "components/tab/1.0.1/tab", "common/validateForm/0.0.1/validateForm", "pages/config/1.0.0/config" ], function(require) {
