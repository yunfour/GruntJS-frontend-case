define("pages/devMyAccount/1.0.0/devMyAccount-debug", [ "$-debug", "components/vScroll/0.0.1/vScroll-debug", "components/tab/1.0.1/tab-debug", "common/validateForm/0.0.1/validateForm-debug", "pages/config/1.0.0/config-debug" ], function(require) {
