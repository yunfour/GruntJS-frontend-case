 ...
 *              callback——事件回调函数
 */
define("base/pubSub/1.0.4/pubSub-debug", [ "base/createClass/1.0.2/createClass-debug" ], function(require, exports, module) {
    ...
    function trigger(eventName) {
        var that = this, events = that.getAttr("events"), args = Array.prototype.slice.apply(arguments), eventsFn;
        // 记录无效事件会点函数的索引
